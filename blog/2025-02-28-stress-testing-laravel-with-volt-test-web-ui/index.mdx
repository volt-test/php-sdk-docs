...
keywords: ["stress testing laravel", "laravel load testing", "laravel performance testing", "volt-test laravel"]
...
composer install
```
**For _Windows_ users,** Visit the installation guide [here](https://docs.volt-test.com/docs/installation#running-on-windows)
